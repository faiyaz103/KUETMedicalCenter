<x-admin-layout>
    <section class="container px-2 py-6 mx-auto max-w-6xl">
        ...
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-2xl font-semibold text-gray-800">Available Units</h2>
            ...
            <div class="min-w-full table-responsive">
                <table class="min-w-full divide-y divide-gray-200 table-auto">
                    ...
                    <tbody class="bg-white divide-y divide-teal-800">
                        ...
                        <tr>
                            <td class="px-2 py-2 text-xs text-gray-800 whitespace-nowrap">{{ $unit->name }}</td>
                            ...
                            <td class="px-2 py-2 text-xs text-center whitespace-nowrap">
                                ...
                                <form action="{{ route('units.destroy', $unit->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete ?')">
                                    @csrf
                                    @method('DELETE')
