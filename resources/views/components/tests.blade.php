<section class="container mx-auto px-2 py-6 max-w-7xl">
    <div class="flex flex-col">
        <label for="collapse1" class="rounded-md block border-2 border-teal-800 bg-teal-800 text-white h-20 px-4 py-2 text-lg font-semibold cursor-pointer max-w-sm hover:bg-green-200 hover:text-teal-900 flex items-center items-center">
            Available Tests
                ...
                <table class="min-w-full divide-y divide-gray-200 text-sm">
                    <thead class="bg-green-200">
                        <tr>
                            ...
                            <th class="px-2 py-2 text-left text-gray-800">Name of the Test</th>
                    ...
                    <tbody class="bg-white divide-y divide-teal-800">
                        ...
                        <tr>
                            ...
                            <td class="px-2 py-2 text-md font-semibold text-gray-800">{{ $test->name }}</td>
                            <td class="px-2 py-2 text-gray-800">{{ $test->fees }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
